...
namespace margelo::nitro::lumawake::app::torch::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<HybridRNTorchSpec>`.
   */
  using std__shared_ptr_HybridRNTorchSpec_ = std::shared_ptr<HybridRNTorchSpec>;
  ...
  // pragma MARK: std::weak_ptr<HybridRNTorchSpec>
  using std__weak_ptr_HybridRNTorchSpec_ = std::weak_ptr<HybridRNTorchSpec>;
  inline std__weak_ptr_HybridRNTorchSpec_ weakify_std__shared_ptr_HybridRNTorchSpec_(const std::shared_ptr<HybridRNTorchSpec>& strong) noexcept { return strong; }
